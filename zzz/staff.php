    ...
    <div class="jumbotron jumbotron-fluid ">
      ...
      <form class="p-5 p-10 my-5" action="staffs.php" method="post" style="width:90%; margin: 0 auto; padding:10%;">
          <div class="form-group">
            ...
            <input type="text" name="staff_name" id="staff_name" class="form-control" placeholder="enter a category name">
          </div>

          <div class="form-group">
            <label for="Email">Staff Email</label>
            <input type="email" name="staff_email" id="staff_email" class="form-control" placeholder="enter category descrition">
          </div>

          <div class="form-group">
            <label for="post">post</label>
            <input type="text" name="staff_post" id="staff_post" class="form-control" placeholder="enter category descrition">
          </div>

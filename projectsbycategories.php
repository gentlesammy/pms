...
if (isset($_POST['cat_find'])) {
  // code...

  $category_select  =   $_POST['category_select'];

  $sql="SELECT * FROM ((admin INNER JOIN project ON admin.admin_id=project.user_id) INNER JOIN category ON category.cat_id=project.cat_id) WHERE (category.cat_id = $category_select)";
